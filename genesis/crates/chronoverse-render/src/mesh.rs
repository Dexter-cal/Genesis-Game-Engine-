...
pub mod viewport {
    ...
    pub struct Viewport {
        ...
        pub player_index: u8,
        pub clear_color: chronoverse_math::color::Color,
        pub hdr: bool,
    ...
    impl Viewport {
        pub fn fullscreen(camera_entity: Option<String>) -> Self {
            Self {
                ...
                camera_entity,
                player_index: 0,
                clear_color: chronoverse_math::color::Color::new(0.05, 0.05, 0.08, 1.0),
                hdr: true,
                msaa_samples: 4,
                active: true,
                render_ui: true,
...
pub mod plugin {
    use chronoverse_core::{plugin::Plugin, engine::Engine};
